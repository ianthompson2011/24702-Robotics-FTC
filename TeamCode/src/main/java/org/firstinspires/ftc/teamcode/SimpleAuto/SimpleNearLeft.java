...
@Autonomous(name = "SimpleNearLeft")
public class SimpleNearLeft extends OpMode {
    ...
    private final Pose parkDirectPose = new Pose(60,  130, Math.toRadians(90));  // park-only destination
